...
students_list_json = StudentsListJson.new("../../files/students_list.json")
puts students_list_json.find_student_by_id(2)
...
students_list_json.replace_student_by_id(1, new_student)
students_list_json.delete_student_by_id(2)
puts students_list_json.size
students_short_list = students_list_json.get_k_n_student_short_list(1, 2)
puts students_short_list.get_data
students_list_json.sort_students_by_fullname
