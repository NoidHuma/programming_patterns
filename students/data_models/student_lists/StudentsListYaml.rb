...
students_list_yaml = StudentsListYaml.new("../../files/students_list.yaml")
puts students_list_yaml.find_student_by_id(2)
...
students_list_yaml.add_student(new_student)
...
students_list_yaml.replace_student_by_id(1, new_student)
students_list_yaml.delete_student_by_id(2)
puts students_list_yaml.size
students_short_list = students_list_yaml.get_k_n_student_short_list(1, 2)
puts students_short_list.get_data
students_list_yaml.sort_students_by_fullname
students_list_yaml.write_to_file